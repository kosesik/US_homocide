...
```{r}
round(prop.table(table(train_set$Crime_Solved)),4)
round(prop.table(table(test_set$Crime_Solved)),4)
...
data_adj<-data[complete.cases(data),]
data_adj<-sapply(data_adj,as.numeric)
