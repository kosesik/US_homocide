...
train_set_balanced<-ovun.sample(Crime_Solved~., data=train_set,method="under",
...
model_log<-bayesglm(Crime_Solved~.,data=train_set_balanced, family=binomial (link="logit"))
